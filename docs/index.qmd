...
As explained in @sec-context, the activity of the coding engine is monitored in almost real-time. This monitoring is essential to detect anomalies in the real life data, or to be able to make decision on when to retrain the ML model behind the engine. The monitoring system is made up of two distinct blocks:
